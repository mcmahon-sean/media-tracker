<?php
    ...
    // Required
    require_once '../php/LastFm/get-loved-tracks.php';
    require_once '../php/LastFm/get-recent-tracks.php';
    require_once '../php/LastFm/get-top-albums.php';
    require_once '../php/LastFm/get-top-artists.php';
