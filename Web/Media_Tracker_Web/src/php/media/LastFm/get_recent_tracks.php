...
if(isset($_SESSION['signed_in']) && $_SESSION['signed_in'] === true) {
    ...
    if(!isset($_SESSION['user_platform_ids']['lastfm'])) {
        ...
        $url = "https://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=$username&api_key=$apiKey&format=json&limit=10";
        ...
        if ($response === false) {
            ...
            $recentTracks = array_map(fn($item) => new LastFmTrack($item), $trackList);
        }
    }
