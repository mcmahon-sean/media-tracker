                ...
                <div class="table-responsive">
                    ...
                    <?php else: ?>
                        <div class="form-container">
                            <form id="signUpForm" action="../authentication/create_user.php" method="post">
                            <h3 class="mb-4">Sign Up</h3>
                                <div class="row mb-3 mx-1">
                                    <label class="form-label col-xxl-2 col-lg-3 col-md-4 lead" for="username">
                                        Username:
                                    </label>
                                ...
                                <div class="row mb-3 mx-1">
                                    <label class="form-label col-xxl-2 col-lg-3 col-md-4 lead" for="first_name">
                                        First Name:
                                    </label>
                                    <div class="col-xl-5 col-lg-8 col-md">
                                ...
                                <div class="row mb-3 mx-1">
                                    <label class="form-label col-xxl-2 col-lg-3 col-md-4 lead" for="last_name">
                                        Last Name:
                                    </label>
                                    <div class="col-xl-5 col-lg-8 col-md">
                                ...
                                <div class="row mb-3 mx-1">
                                    <label class="form-label col-xxl-2 col-lg-3 col-md-4 lead" for="email">
                                        Email:
                                    </label>
                                    <div class="col-xl-5 col-lg-8 col-md">
                                ...
                                <div class="row mb-3 mx-1">
                                    <label class="form-label col-xxl-2 col-lg-3 col-md-4 lead" for="password">
                                        Password:
                                    </label>
                                    <div class="col-xl-5 col-lg-8 col-md">
                                ...
                                <input class="btn bg-dark-secondary text-white" type="submit" value="Sign Up">
                            </form>
                        </div>
                    <?php endif; ?>
                </div>
