<?php
    ...
    // Required
    require_once '../media/LastFm/get-loved-tracks.php';
    require_once '../media/LastFm/get-recent-tracks.php';
    require_once '../media/LastFm/get-top-albums.php';
    require_once '../media/LastFm/get-top-artists.php';
